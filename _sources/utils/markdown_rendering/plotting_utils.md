...
This is a markdown rendering of the `plotting_utils` module used in the notebooks. It is provided here for user reference. The code can be viewed and downloaded from the github repository.
