...
This is a markdown rendering of the misc_utils module used in the notebooks. It is provided here for user reference. The `misc_utils.py` module can be viewed and downloaded from the github repository. 
